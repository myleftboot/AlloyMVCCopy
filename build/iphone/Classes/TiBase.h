...
// in simulator we redefine to format for AlloyMVCCopy Developer console
...
{\
	NSString * exceptionName = [@"org.alloymvccopy." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.alloymvccopy";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIAlloyMVCCopyNativeItemNone = -1, 
	UIAlloyMVCCopyNativeItemSpinner = -2,
	UIAlloyMVCCopyNativeItemProgressBar = -3,
	
	UIAlloyMVCCopyNativeItemSlider = -4,
	UIAlloyMVCCopyNativeItemSwitch = -5,
	UIAlloyMVCCopyNativeItemMultiButton = -6,
	UIAlloyMVCCopyNativeItemSegmented = -7,
	
	UIAlloyMVCCopyNativeItemTextView = -8,
	UIAlloyMVCCopyNativeItemTextField = -9,
	UIAlloyMVCCopyNativeItemSearchBar = -10,
	
	UIAlloyMVCCopyNativeItemPicker = -11,
	UIAlloyMVCCopyNativeItemDatePicker = -12,
	
	UIAlloyMVCCopyNativeItemInfoLight = -13,
	UIAlloyMVCCopyNativeItemInfoDark = -14,
	
	UIAlloyMVCCopyNativeItemDisclosure = -15,
	
	UIAlloyMVCCopyNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AlloyMVCCopy instances of
