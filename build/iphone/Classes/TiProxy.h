...
//Rare exceptions to indicate a bug in the _alloymvccopy code (Eg, function that a subclass should have implemented)
...
/**
 The base class for AlloyMVCCopy proxies.
 */
