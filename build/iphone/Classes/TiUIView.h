...
/**
 Base class for all AlloyMVCCopy views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AlloyMVCCopy view hierarchy (such as wrapped iOS UIViews) was touched.
