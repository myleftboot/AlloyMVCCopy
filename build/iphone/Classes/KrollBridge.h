...
@interface AlloyMVCCopyObject : KrollCoverageObject {
#else
@interface AlloyMVCCopyObject : KrollObject {
#endif
@private
...
extern NSString * AlloyMVCCopy$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AlloyMVCCopyObject *_alloymvccopy;
    KrollObject* console;
	BOOL shutdown;
