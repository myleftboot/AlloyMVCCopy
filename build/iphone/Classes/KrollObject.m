 ...
 * Copyright (c) 2009-2011 by AlloyMVCCopy, Inc. All Rights Reserved.
...
//@interface AlloyMVCCopyObject : NSObject
//@end

@interface AlloyMVCCopyObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AlloyMVCCopyObject class]])
		{
			for (NSString *key in [[(AlloyMVCCopyObject*)o modules] allKeys])
			{
